  ...
  return (
    <>
      ...
      <div className="w-full">
        <Head>
          <title>AR ECommerce</title>
          <meta
            name="description"
            content="AR ECommerce Next provides a way to quickly get up and running with a fully configurable ECommerce site using Next.js."
          />
          <meta property="og:title" content="AR ECommerce" key="title" />
        </Head>
        <div
